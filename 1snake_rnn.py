...
ALWAYS_VISUALIZE = True  # Ustawienie na True powoduje, że inicjalizujemy moduł Pygame
...
for episode in range(1, MAX_EPISODES + 1):
    ...
    if(episode%5 == 0): mstep_helper = 0 
    else: mstep_helper += episode_score

    if(mstep_helper > mMAX_STEPS*4): mMAX_STEPS *= 1.5
